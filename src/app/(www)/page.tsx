          ...
          <div key={category.id} className='my-10'>
            ...
            <div className='grid grid-cols-2 lg:grid-cols-4 '>
              {category.goods?.map(goods =>
                <CardComponent key={goods.id} description={goods.description} id={goods.id} img={goods.img} title={goods.name} content={goods.flavor} link={`/shop/${goods.id}`} flavor={goods.flavor} />
              )}
            </div>
          </div>)}
      </Container>
