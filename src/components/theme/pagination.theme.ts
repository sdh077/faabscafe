import type { FlowbitePaginationTheme } from '@ui/Pagination/Pagination';

const pagination: FlowbitePaginationTheme = {
  base: 'flex flex-col items-center overflow-x-auto sm:justify-center',
  layout: {
    table: {
  ...
  pages: {
    ...
    previous: {
      base: 'ml-0 border border-gray-300 bg-bule-500 py-2 px-3 leading-tight text-gray-500 enabled:hover:bg-gray-100 enabled:hover:text-gray-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 enabled:dark:hover:bg-gray-700 enabled:dark:hover:text-white',
      icon: 'h-5 w-5',
    },
    next: {
