...
// import type { FlowbiteButtonTheme } from '@ui/Pagination/Pagination';
...
export const buttonTheme: FlowbiteButtonTheme = {
  ...
  fullSized: 'w-full',
  color: {
    default: 'text-gray-900 bg-gray-200 border border-transparent enabled:hover:bg-gray-400 focus:ring-gray-300',
  ...
  inner: {
    base: 'flex items-stretch items-center justify-between gap-2 transition-all duration-75',
    position: {
      none: '',
